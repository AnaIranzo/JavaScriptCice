...
function cesta() {
    ...
    if (manzana >0){
        ...
        for (let i = 0; i < manzana; i++) {
           manzanaPic += `<img src = "/Users/AnaE/Desktop/9_-_Ejercicios_JavaScript_Eventos/iconos/manzana.png" width="50px"/> `
             } console.log(manzanaPic)
             impresion += `<h5>Manzana</h5><p>${manzana} ${manzanaPic}</p>`}
    if (carne >0){
        let carnePic = ""
        for (let i = 0; i < carne; i++) {
           carnePic += `<img src = "/Users/AnaE/Desktop/9_-_Ejercicios_JavaScript_Eventos/iconos/carne.png" width="50px"/> `
             }
    ...
    if (leche >0){
        ...
        for (let i = 0; i < leche; i++) {
           lechePic += `<img src = "/Users/AnaE/Desktop/9_-_Ejercicios_JavaScript_Eventos/iconos/leche.png" width="50px"/> `
             }
        impresion += `<h5>Leche</h5><p>${leche} ${lechePic}</p>`}
    if (pescado > 0){
        let pescadoPic = ""
        for (let i = 0; i < pescado; i++) {
           pescadoPic += `<img src = "/Users/AnaE/Desktop/9_-_Ejercicios_JavaScript_Eventos/iconos/pescado.png" width="50px"/> `
             }
